...
v1.include_router(watches_router)
v1.include_router(changes_router)
v1.include_router(profiles_router)
v1.include_router(notification_configs_router)
v1.include_router(audit_router)
v1.include_router(domains_router)
v1.include_router(probe_router)
